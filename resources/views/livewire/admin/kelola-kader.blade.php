<main class="p-1 min-w-full mx-auto space-y-6">
    ...
    @endslot
    <flux:fieldset>
        <flux:legend>Daftar Kader</flux:legend>
        <flux:description>Berikut adalah data Kader Sistem Anda!</flux:description>
        <div class="min-h-screen">
            ...
            <flux:modal name="add-user" class="md:w-xl">
                <form wire:submit.prevent="store" class="space-y-6">
                    <div>
                        <flux:heading size="lg">Tambah Kader</flux:heading>
                        <flux:text class="mt-2">Buatkan akun untuk Kader yang belum terdaftar dalam sistem!
                        </flux:text>
                    </div>
            ...
            <flux:modal name="edit-user" class="md:w-xl">
                <form wire:submit.prevent="update" class="space-y-6">
                    <div>
                        <flux:heading size="lg">Update Kader</flux:heading>
                        <flux:text class="mt-2">Update data Kader yang sudah terdaftar dalam sistem.</flux:text>
                    </div>
                    ...
                    <flux:input :invalid="$errors->has('tanggal_lahir')" wire:model="tanggal_lahir" type="date"
                        label="Tanggal Lahir" placeholder="Tanggal Lahir" />
                    <flux:select placeholder="Jenis Kelamin" wire:model='jenis_kelamin' label="Jenis Kelamin"
                        :invalid="$errors->has('jenis_kelamin')">
                        <flux:select.option value="">Pilih Jenis Kelamin</flux:select.option>
                        <flux:select.option value="L" selected>Laki-laki</flux:select.option>
                        <flux:select.option value="P">Perempuan</flux:select.option>
                    ...
                    <div class="flex">
                        <flux:spacer />
                        <flux:button type="submit" variant="primary">Edit Kader</flux:button>
                    </div>
                </form>
            </flux:modal>
