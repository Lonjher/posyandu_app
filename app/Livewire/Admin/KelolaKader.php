...
class KelolaKader extends Component
{
    use WithPagination;
    public $search = '';
    public $perPage = 10;
    ...
    public function render()
    {
        ...
        return view('livewire.admin.kelola-kader', [
            'users' => $users
        ]);
    }
    ...
    public function confirmDelete(User $user)
    {
        $this->dispatch(
            ...
            text: "Apakah Anda yakin ingin menghapus data Kader ini? Tindakan ini tidak dapat dibatalkan.",
            id: $user->id_user
        );
    }
